 ...
 * @param {Integer} options.id ID of the User to get.
 * @throws {Error}
 * @return {Promise}
 */
module.exports.getUserDetail = async (options) => {
  ...
  return {
    status: 200,
    data: 'getUserDetail ok!'
  };
};

/**
 * @param {Object} options
 * @param {Integer} options.id The ID of the User.
 * @throws {Error}
 * @return {Promise}
 */
